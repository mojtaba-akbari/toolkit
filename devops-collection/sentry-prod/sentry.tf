...
system:
  ...
  url: "https://sentry.snapp.express"
...
service:
  ...
  annotations: 
    cloud.networking.cafebazaar.cloud/load-balancer: zooket-sentry
    cloud.networking.cafebazaar.cloud/load-balancer-external-ip: zooket-sentry-lb
  ...
  # #loadBalancerSourceRanges: []
  # annotations: 
  #   cloud.networking.cafebazaar.cloud/load-balancer: zooket-relay
  #   cloud.networking.cafebazaar.cloud/load-balancer-external-ip: zooket-relay-lb
  ...
  # #loadBalancerSourceRanges: []
  # annotations: 
  #   cloud.networking.cafebazaar.cloud/load-balancer: zooket-snuba
  #   cloud.networking.cafebazaar.cloud/load-balancer-external-ip: zooket-snuba-lb
