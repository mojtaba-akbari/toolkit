...
global:
  ...
  ##
  imagePullSecrets: []
  storageClass: "devspace-local-storage28"
...
service:
  ...
  ##
  proxyHttpNodePort: "31054"
  proxyHttpsNodePort: "31724"
  adminHttpNodePort: "31214"
  adminHttpsNodePort: "31994"
...
ingress:
  ...
  ##
  extraHosts:
  - name: api.snappxtage.ir
    path: /
  - name: vendor.snappxtage.ir
    path: /
  - name: vmsapi.snappxtage.ir
    path: /
  - name: stock.snappxtage.ir
    path: /
  - name: auth.snappxtage.ir
    path: /
  - name: search.snappxtage.ir
    path: /
  - name: api.snapp.express
    path: /
