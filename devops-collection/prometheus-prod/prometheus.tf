...
resource "helm_release" "prometheus" {
  ...
  wait       = "false"
  depends_on = [null_resource.prometheus_community]
...
grafana:
  ...
  ##
    annotations: 
      cloud.networking.cafebazaar.cloud/load-balancer: zooket-monitoring
      cloud.networking.cafebazaar.cloud/load-balancer-external-ip: zooket-monitoring-lb
...
prometheus:
  ...
  prometheusSpec:
    ...
    additionalScrapeConfigs:
        - job_name: 'mysqld_exporter-replica1'
          static_configs:
          - targets: ['194.34.162.37:9104']
          metrics_path: /metrics

        - job_name: 'mysqld_exporter-replica2'
          static_configs:
          - targets: ['194.34.162.38:9104']
          metrics_path: /metrics

        - job_name: 'kong-metrics.api-gateway'
          static_configs:
          - targets: ['10.0.0.16:31518']
          metrics_path: /metrics

        - job_name: 'traefik.ingress.svc.cluster.local'
          static_configs:
          - targets: ['10.0.0.16:9100']
          metrics_path: /metrics

        - job_name: 'mysql-db-core-galera'
          static_configs:
          - targets: ['87.247.186.180:9100']
          metrics_path: /metrics

      # - job_name: 'prometheus-mysql-exporter'
      #   metrics_path: /metrics
      #   params:
      #     module: [http_2xx]
      #   static_configs:
      ...
      #       replacement: prometheus-mysql-exporter:9104
